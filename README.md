...
It is an imbalanced dataset where outliers have a huge role so it is anamoly detection problem in machine learning problems where we use isolation forest,local outlier factor anomaly detection for model selection and prediction.
